    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-sm text-white/50 mb-3">has successfully earned</p>

          <h3 className="text-xl md:text-2xl font-bold mb-2" style={{ color: certConfig.color }}>
            {certConfig.title}
          </h3>
          <p className="text-sm text-white/40 mb-6">{certConfig.subtitle}</p>
          ...
          <div className="flex items-center justify-center gap-8 pt-6 border-t" style={{ borderColor: `${certConfig.color}15` }}>
            <div className="text-center">
              ...
              <p className="text-xs text-white/30">Date Issued</p>
              <p className="text-sm text-white/60 mt-0.5">{issuedDate}</p>
            </div>
            <div
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-white/[0.05] border border-white/10 text-white text-sm font-medium hover:bg-white/[0.08] transition-colors"
          >
        ...
        <div className="text-center mt-6">
          <Link to="/institute/dashboard" className="text-white/30 text-sm hover:text-white transition-colors">
            ← Back to Dashboard
          </Link>
        </div>
      </div>
