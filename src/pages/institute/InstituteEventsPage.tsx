...
const eventTypes = [
  {
    icon: <Video size={20} className="text-[#00FFE1]" />,
    title: 'Webinars',
  ...
  {
    icon: <Users size={20} className="text-[#00FFE1]" />,
  ...
  {
    icon: <BookOpen size={20} className="text-[#00FFE1]" />,
  ...
  {
    icon: <Calendar size={20} className="text-[#00FFE1]" />,
    ...
    <div className="bg-[#04080f]">
      ...
      <section className="py-20 border-b border-white/[0.06]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-[10px] uppercase tracking-[0.2em] text-[#c9a96e] font-bold mb-4">Community Events</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#0d1b3e]/30 border border-[#0d1b3e] rounded-2xl p-8 text-center">
            <div className="w-16 h-16 rounded-full bg-[#00FFE1]/10 border border-[#00FFE1]/20 flex items-center justify-center mx-auto mb-5">
              <Calendar size={28} className="text-[#00FFE1]" />
            </div>
            ...
            {!submitted ? (
              ...
              <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#00FFE1]/10 border border-[#00FFE1]/20 rounded-lg">
                <Bell size={14} className="text-[#00FFE1]" />
                <span className="text-[#00FFE1] text-sm font-medium">You're on the list — we'll be in touch.</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {eventTypes.map((et) => (
              <div
                key={et.title}
                className="bg-white/[0.025] border border-white/[0.06] rounded-xl p-6 hover:border-white/[0.1] transition-all"
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-lg bg-[#00FFE1]/10 border border-[#00FFE1]/20 flex items-center justify-center shrink-0">
                    {et.icon}
                  </div>
                  <div>
                    <h3 className="text-white font-bold">{et.title}</h3>
                    <span className="text-white/30 text-xs">{et.cadence}</span>
                  </div>
                </div>
                <p className="text-white/50 text-sm leading-relaxed">{et.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-4">
            {upcomingPlaceholders.map((event, i) => (
              <div
                key={i}
                className="bg-white/[0.025] border border-white/[0.06] rounded-xl p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4"
              >
                <div>
                  ...
                  <p className="text-white/40 text-sm mt-1">{event.date}</p>
                </div>
