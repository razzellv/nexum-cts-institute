    ...
    <div className="w-full">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          {ARTICLES.map((article) => {
            ...
            return (
              <Link
                key={article.slug}
                to={`/institute/publications/${article.slug}`}
                className="block group bg-white/[0.025] hover:bg-white/[0.04] border border-white/[0.07] hover:border-white/[0.12] rounded-2xl p-7 transition-all duration-200"
              >
      ...
      <section className="py-16 px-4 bg-[#020509] border-t border-white/[0.06]">
        <div className="max-w-xl mx-auto text-center">
          ...
          <Link to="/institute/membership" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold text-black transition-all" style={{ backgroundColor: '#c9a96e' }}>
            Become a Member
